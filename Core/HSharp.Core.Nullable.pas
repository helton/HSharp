...
{
  # Author: Allen Bauer
  # Link: http://blogs.embarcadero.com/abauer/2008/09/18/38869
}

unit HSharp.Core.Nullable;
...
type
  ENullableHasNoValue = class(Exception);
...
begin
  if not HasValue then
    raise ENullableHasNoValue.Create('Invalid operation, Nullable type has no value');
  Result := FValue;
end;
