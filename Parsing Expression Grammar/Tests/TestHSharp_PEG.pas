...
//    Arr.Add('#   - Parselet (in Ruby)       <https://github.com/kschiess/parslet>');
  ...
  begin
    ...
    Arr.Add('                      <Node called "term_label" matching "">');
    ...
    Arr.Add('                          <Node called "term_label" matching "">');
    Arr.Add('                          <Node called "factor" matching "rule+\n">');
    ...
    Arr.Add('                      <Node called "term_label" matching "">');
    Arr.Add('                      <Node called "factor" matching "identifier ">');
    ...
    Arr.Add('                          <Node called "term_label" matching "">');
    Arr.Add('                          <Node called "factor" matching "assignment ">');
    ...
    Arr.Add('                          <Node called "term_label" matching "">');
    Arr.Add('                          <Node called "factor" matching "expression\n">');
    ...
    Arr.Add('                      <Node called "term_label" matching "">');
    Arr.Add('                      <Node called "factor" matching "ored ">');
    ...
    Arr.Add('                              <Node called "term_label" matching "">');
    Arr.Add('                              <Node called "factor" matching "sequence ">');
    ...
    Arr.Add('                              <Node called "term_label" matching "">');
    Arr.Add('                              <Node called "factor" matching "term\n">');
    ...
    Arr.Add('                          <Node called "term_label" matching "">');
    Arr.Add('                          <Node called "factor" matching "or_term+\n">');
    ...
    Arr.Add('                      <Node called "term_label" matching "">');
    Arr.Add('                      <Node called "factor" matching "lookahead_term ">');
    ...
    Arr.Add('                              <Node called "term_label" matching "">');
    Arr.Add('                              <Node called "factor" matching "negative_lookahead_term ">');
    ...
    Arr.Add('                              <Node called "term_label" matching "">');
    Arr.Add('                              <Node called "factor" matching "quantified ">');
    ...
    Arr.Add('                              <Node called "term_label" matching "">');
    Arr.Add('                              <Node called "factor" matching "repetition ">');
    ...
    Arr.Add('                              <Node called "term_label" matching "">');
    Arr.Add('                              <Node called "factor" matching "atom\n">');
    ...
    Arr.Add('                          <Node called "term_label" matching "">');
    Arr.Add('                          <Node called "factor" matching "quantifier\n">');
    ...
    Arr.Add('                      <Node called "term_label" matching "">');
    Arr.Add('                      <Node called "factor" matching "reference ">');
    ...
    Arr.Add('                              <Node called "term_label" matching "">');
    Arr.Add('                              <Node called "factor" matching "literal ">');
    ...
    Arr.Add('                              <Node called "term_label" matching "">');
    Arr.Add('                              <Node called "factor" matching "regex ">');
    ...
    Arr.Add('                              <Node called "term_label" matching "">');
    Arr.Add('                              <Node called "factor" matching "parenthesized\n">');
    ...
    Arr.Add('                          <Node called "term_label" matching "">');
    Arr.Add('                          <Node called "factor" matching "/[imesp]*/i? ">');
    ...
    Arr.Add('                          <Node called "term_label" matching "">');
    Arr.Add('                          <Node called "factor" matching "/{[0-9]+(\s*,\s*([0-9]+)?)?}/ ">');
    ...
    Arr.Add('                      <Node called "term_label" matching "">');
    Arr.Add('                      <Node called "factor" matching "/[a-z_][a-z0-9_]*/i ">');
    ...
    Arr.Add('                              <Node called "term_label" matching "">');
    Arr.Add('                              <Node called "factor" matching "comment\n">');
